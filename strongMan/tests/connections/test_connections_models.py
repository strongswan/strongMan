...
class ConnectionModelTest(TestCase):
    ...
    def setUp(self):
        ...
        Authentication(name='remote-1', identity='home', auth='pubkey', remote=connection).save()
        Authentication(name='local-1', identity='home', auth='pubkey', local=connection).save()
